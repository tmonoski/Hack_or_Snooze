...
class StoryList {
  ...
  async addStory(user, { title, author, url }) {
    ...
    const savedStory = new Story(res.data.story);

    this.stories.unshift(savedStory);
    user.ownStories.unshift(savedStory);

    return savedStory;
  }

  // deletes story that was added by user from API and all story lists
